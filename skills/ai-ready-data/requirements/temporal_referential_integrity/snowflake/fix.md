...
1. **NULL timestamps** — Backfill from a source system audit column, ingestion metadata (`METADATA$FILE_LAST_MODIFIED`), or set a default value at the column level.
