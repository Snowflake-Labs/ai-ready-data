-- diagnostic-entity-identifier-declaration.sql
-- Lists tables and their primary key / unique constraint status
-- Returns: tables with identifier declaration details
